...
public class View_share extends JFrame
{
    ...
    public View_share() {
        ...
        (this.imagearea1 = new JLabel("")).setIcon(new ImageIcon("./images/share1.png"));
        (this.imagearea2 = new JLabel("")).setIcon(new ImageIcon("./images/share2.png"));
        ...
        (this.home = new JButton("", new ImageIcon("./images/button-home.jpg"))).setToolTipText("Diplays Home Page.");
