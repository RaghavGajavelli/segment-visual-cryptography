...
class DigitPanel extends JPanel
{
    ...
    DigitPanel(final char a) {
        this.topRectangle = new Rectangle(27, 65, 45, 2);
        this.topRectangle1 = new Rectangle(27, 70, 45, 2);
        this.leftTopRectangle = new Rectangle(15, 75, 2, 50);
        this.leftTopRectangle1 = new Rectangle(20, 75, 2, 50);
        this.leftBottomRectangle = new Rectangle(15, 139, 2, 50);
        this.leftBottomRectangle1 = new Rectangle(20, 139, 2, 50);
        this.bottomRectangle = new Rectangle(27, 195, 45, 2);
        this.bottomRectangle1 = new Rectangle(27, 190, 45, 2);
        this.rightBottomRectangle = new Rectangle(77, 139, 2, 50);
        this.rightBottomRectangle1 = new Rectangle(82, 139, 2, 50);
        this.rightTopRectangle = new Rectangle(77, 78, 2, 50);
        this.rightTopRectangle1 = new Rectangle(82, 78, 2, 50);
        this.midRectangle = new Rectangle(27, 130, 45, 2);
